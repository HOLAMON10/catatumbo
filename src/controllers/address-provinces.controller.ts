...
import { AddressProvincesService } from '../services';
import { ServiceResultInterface } from '../interfaces/service-result.interface';
import { handleErrorResponse, ValidationError } from '../error-handlers';
import { AddressProvinceModelInterface } from 'src/interfaces/models';

@controller(ConstantValues.addressprovinces)
export class AddressProvincesController implements interfaces.Controller {
  private dataSrv: AddressProvincesService;

  public constructor(
    @inject(ApiTypes.addressProvincesService) dataSrv: AddressProvincesService
  ) {
